...
import com.yc.ycmvvm.utils.YcRandom
import com.yc.ycmvvm.utils.YcResources
...
class YcDownload(val mConfig: YcDownloadConfig) {
    companion object {
        ...
        fun createDownloadFile(
            ...
            onSuccess: ((result: File) -> Unit)? = null,
            onFail: ((error: String?) -> Unit)? = null
        ) = YcDownload(YcDownloadConfig(url, YcInit.mInstance.mDefaultSaveDirPath + saveFileName, onSuccess, onFail))
