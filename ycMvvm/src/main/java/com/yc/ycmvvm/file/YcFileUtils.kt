...
//    }
    ...
    fun getInternalPath(): String {
        return if (Build.VERSION.SDK_INT < Build.VERSION_CODES.Q) {
            ...
            YcInit.mInstance.mApplication.filesDir.path
        }
    }
    ...
    fun getExternalPath(fileType: String = Environment.DIRECTORY_DCIM): String? {
        return if (Environment.getExternalStorageState() == Environment.MEDIA_MOUNTED) {
            YcInit.mInstance.mApplication.getExternalFilesDir(fileType)?.path
        } else {
